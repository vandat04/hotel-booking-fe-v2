...
## API: check: POST /receptionist/bookings/check
...
## API: createWalkIn: POST /receptionist/bookings/walk-in
**Role:** `RECEPTIONIST` or `ADMIN`
...
## API: getAllBookings: GET /receptionist/bookings
 **Role:** `RECEPTIONIST` or `ADMIN`
...
## API: getBookingDetail: GET /receptionist/bookings/{bookingId}
**Role:** `RECEPTIONIST` or `ADMIN`
...
## API: searchBookings: GET /receptionist/bookings/search
**Role:** `RECEPTIONIST` or `ADMIN`
...
## API: cancelBooking: PUT /receptionist/bookings/{bookingId}/cancel
**Role:** `RECEPTIONIST` or `ADMIN`
...
## API: refundBooking: PUT /receptionist/bookings/{bookingId}/refund
**Role:** `RECEPTIONIST` or `ADMIN`
...
## API: createReceptionPayment: POST /receptionist/bookings/pay
**Role:** `RECEPTIONIST` or `ADMIN`
...
## API: checkInBooking: POST /receptionist/bookings/{bookingId}/check-in
**Role:** `RECEPTIONIST` or `ADMIN`
...
## API: checkOutBooking: POST /receptionist/bookings/{bookingId}/check-out
**Role:** `RECEPTIONIST` or `ADMIN`
...
## API: getUpcomingCheckIns: GET /receptionist/bookings/upcoming-checkin
**Role:** `RECEPTIONIST` or `ADMIN`
...
## API: getUpcomingCheckOut: GET /receptionist/bookings/upcoming-checkout
**Role:** `RECEPTIONIST` or `ADMIN`
...
## API: getWeeklyActive: GET /receptionist/dashboard/room-weekly-active
**Role:** `RECEPTIONIST` or `ADMIN`
...
## API: getAll: GET /receptionist/dashboard/customer-notification
**Role:** `RECEPTIONIST` or `ADMIN`
...
# 22. Controller: RoomRealtimeController
**Security:** Requires `ROLE_RECEPTIONIST` or `ROLE_ADMIN` (JWT Required).
